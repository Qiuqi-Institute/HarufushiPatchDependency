...
void StudioSplashScene::render(engine::graphics::RenderQueue& queue,
    ...
    const auto white = engine::graphics::Color{255, 255, 255, 255};
    const auto ink = engine::graphics::Color{21, 42, 96, 255};
    ...
    queue.fillRect({pigX + 36, pigY + 44, 164, 94}, pale);
    queue.fillRect({pigX + 48, pigY + 56, 140, 70}, blue);
    queue.fillRect({pigX + 66, pigY + 76, 28, 24}, ink);
    queue.fillRect({pigX + 142, pigY + 76, 28, 24}, ink);
    ...
    queue.fillRect({pigX + 100, pigY + 119, 12, 12}, ink);
    queue.fillRect({pigX + 124, pigY + 119, 12, 12}, ink);
    ...
    queue.fillRect({centerX - 280, centerY + 220, 42, 6}, violet);
    queue.fillRect({centerX + 238, centerY + 220, 42, 6}, blue);
    queue.fillRect({centerX - 254, centerY + 248, 18, 6}, cyan);
    queue.fillRect({centerX + 236, centerY + 248, 18, 6}, cyan);
    queue.drawText({centerX - 260, centerY + 212, 520, 64}, "Qiuqi Institute", ink);
}
